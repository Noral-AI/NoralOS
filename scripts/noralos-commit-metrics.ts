...
const NORALOS_EMAIL = "noreply@paperclip.ing";
const NORALOS_NAME = "paperclip";
...
function normalizeContributor(input: {
  ...
  if ((email && email === NORALOS_EMAIL) || (displayName && displayName.toLowerCase() === NORALOS_NAME)) {
    return null;
  }
...
function printSummary(summary: Summary) {
  console.log("NoralOS commit metrics");
