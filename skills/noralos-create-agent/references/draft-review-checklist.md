...
- [ ] The first paragraph points at the NoralOS skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the NoralOS execution contract verbatim:
...
- [ ] Adapter config matches this NoralOS instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
