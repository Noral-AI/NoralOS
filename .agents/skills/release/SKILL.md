...
name: release
description: >
  Coordinate a full NoralOS release across engineering verification, npm,
...
Run the full NoralOS maintainer release workflow, not just an npm publish.
...
7. If running through NoralOS, you have issue context for status updates and follow-up task creation.
...
NoralOS now uses a commit-driven release model:
...
npm view noralos@canary version
```
...
- release summary in NoralOS issue context
