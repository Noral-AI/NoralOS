/**
 * Server-side SVG renderer for NoralOS org charts.
...
// NoralOS logo: scaled icon (~16px) + wordmark (13px), vertically centered
const NORALOS_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">NoralOS</text>
</g>`;
