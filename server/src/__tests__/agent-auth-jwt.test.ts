...
describe("agent local JWT", () => {
  const secretEnv = "NORALOS_AGENT_JWT_SECRET";
  const betterAuthSecretEnv = "BETTER_AUTH_SECRET";
  const ttlEnv = "NORALOS_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "NORALOS_AGENT_JWT_ISSUER";
  const audienceEnv = "NORALOS_AGENT_JWT_AUDIENCE";
  ...
  it("falls back to BETTER_AUTH_SECRET when NORALOS_AGENT_JWT_SECRET is absent", () => {
