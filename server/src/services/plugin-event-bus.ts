/**
 * PluginEventBus — typed in-process event bus for the NoralOS plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@noralos/shared";
import type { PluginEvent, EventFilter } from "@noralos/plugin-sdk";
