...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@noralos/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: NoralosPluginManifestV1, pluginDbId?: string): void;
