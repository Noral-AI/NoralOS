 ...
 */
import type { CompanyPortabilityManifest } from "@noralos/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Paperclip](https://noralos.ing)");
  lines.push("");
