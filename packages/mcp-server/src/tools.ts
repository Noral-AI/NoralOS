...
async function getIssueWorkspaceRuntime(client: NoralosApiClient, issueId: string) {
...
export function createToolDefinitions(client: NoralosApiClient): ToolDefinition[] {
  return [
    makeTool(
      "noralosMe",
      "Get the current authenticated NoralOS actor details",
      z.object({}),
    ...
    makeTool(
      "noralosGetIssueWorkspaceRuntime",
    ...
    makeTool(
      "noralosControlIssueWorkspaceServices",
    ...
    makeTool(
      "noralosWaitForIssueWorkspaceService",
    ...
    makeTool(
      "noralosRestoreIssueDocumentRevision",
    ...
    makeTool(
      "noralosApiRequest",
      "Make a JSON request to an existing NoralOS /api endpoint for unsupported operations",
      apiRequestSchema,
