/**
 * `@noralos/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@noralos/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@noralos/plugin-sdk/ui";
 *
