...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current NoralOS plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "NoralOS",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the NoralOS domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
