...
This document describes how `@noralos/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into NoralOS logs/transcript parsing
