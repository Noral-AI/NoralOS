...
async function ensureEmbeddedPostgresConnection(
  ...
  const preferredAdminConnectionString = `postgres://noralos:paperclip@127.0.0.1:${preferredPort}/postgres`;
  ...
  if (!runningPid && existsSync(pgVersionFile)) {
    try {
      ...
      return {
        connectionString: `postgres://noralos:paperclip@127.0.0.1:${preferredPort}/noralos`,
