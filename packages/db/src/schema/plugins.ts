...
import type { PluginCategory, PluginStatus, NoralosPluginManifestV1 } from "@noralos/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<NoralosPluginManifestV1>().notNull(),
