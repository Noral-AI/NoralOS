...
export const cloudUpstreamRuns = pgTable(
  "cloud_upstream_runs",
  {
    ...
    summary: jsonb("summary").$type<import("@noralos/shared").CloudUpstreamSummaryCount[]>().notNull().default([]),
    warnings: jsonb("warnings").$type<import("@noralos/shared").CloudUpstreamWarning[]>().notNull().default([]),
    conflicts: jsonb("conflicts").$type<import("@noralos/shared").CloudUpstreamConflict[]>().notNull().default([]),
    events: jsonb("events").$type<import("@noralos/shared").CloudUpstreamRunEvent[]>().notNull().default([]),
