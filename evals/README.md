...
Eval framework for testing NoralOS agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the NoralOS heartbeat skill:
