...
- Running a Python script that calls the NoralOS API
...
1. NoralOS spawns the configured command as a child process
2. Standard Paperclip environment variables are injected (`NORALOS_AGENT_ID`, `NORALOS_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the NoralOS API and perform work.
