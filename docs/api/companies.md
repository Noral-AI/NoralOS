...
Manage companies within your NoralOS instance.
...
Company logo uploads use the normal NoralOS attachment size limit.
...
| `logoUrl` | string | Optional NoralOS asset content path for the stored logo image |
