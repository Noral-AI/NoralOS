...
NoralOS supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying NoralOS?** Use `local_trusted` (the default)
