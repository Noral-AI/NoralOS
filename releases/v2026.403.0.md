...
- **Telemetry** — Anonymized App-side telemetry. Disable with `DO_NOT_TRACK=1` or `NORALOS_TELEMETRY_DISABLED=1` ([#2527](https://github.com/paperclipai/paperclip/pull/2527))
...
- **Commit metrics** — New NoralOS commit metrics script with filtered exports and edge case handling.
