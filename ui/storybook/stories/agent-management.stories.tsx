  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        NORALOS_TRACE: { type: "plain", value: "storybook" },
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended NoralOS fixtures.",
      },
    },
  },
