...
import { ISSUE_STATUSES, type Issue, type IssueStatus, type Project } from "@noralos/shared";
                      ...
                      <IssueRow
                        ...
                        titleSuffix={(
                          <>
                            ...
                            {(issue.successfulRunHandoff?.state === "required" || issue.successfulRunHandoff?.state === "escalated") ? (
                              <span
