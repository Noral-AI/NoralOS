...
import { NoralMark } from "./brand/NoralLogo";
...
import type { Company } from "@noralos/shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* NoralAI brand mark - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0" aria-label="NoralOS" role="img">
        <NoralMark size={28} />
      </div>
