...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="NoralOS API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label="Claimed API key path">
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder="~/.openclaw/workspace/noralos-claimed-api-key.json"
            />
          </Field>
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. NoralOS persists a device key during onboarding so pairing approvals
