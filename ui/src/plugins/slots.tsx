 ...
 *
 * Plugin bundles are built with `external: ["@noralos/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@noralos/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@noralos/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@noralos/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@noralos/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@noralos/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * self-register via `window.noralosPlugins.registerReactComponent()`.
 ...
 * of `@noralos/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
