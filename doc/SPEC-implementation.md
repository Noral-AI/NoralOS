...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.noralos/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.noralos/instances/default/data/storage` (`local_disk`)
...
- if unset, auto-use embedded PostgreSQL under `~/.noralos/instances/default/db`
