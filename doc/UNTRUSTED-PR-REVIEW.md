...
```sh
review-checkout-pr noralos/noralos 432
cd /work/checkouts/noralosai-paperclip/pr-432
```
...
- NoralOS's embedded PostgreSQL and local storage stay inside the container home volume via `NORALOS_HOME=/home/reviewer/.paperclip-review`.
