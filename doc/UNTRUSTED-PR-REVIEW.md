...
```sh
review-checkout-pr noralos/paperclip 432
...
- Paperclip's embedded PostgreSQL and local storage stay inside the container home volume via `NORALOS_HOME=/home/reviewer/.paperclip-review`.
